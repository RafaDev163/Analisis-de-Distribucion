...
-- Extiende las vistas de inventario para aprovechar linea_familia y proveedor_codigo
-- sin romper las vistas existentes de V5.

-- 1) (Se conserva v_fecha_corte_max de V5) – no lo tocamos

-- 2) Inventario en principal por FAMILIA y MODALIDAD
...
-- 3) Inventario en principal por PROVEEDOR y MODALIDAD
...
-- 4) Inventario en TIENDAS por FAMILIA, TIENDA y MODALIDAD
...
-- 5) Totales por FAMILIA en principal y tiendas (compatibles con las vistas V5)
